...
\begin{enumerate}
\item Take a task you do regularly (weekly status update, meeting summary, competitive scan) and write a structured prompt using the RCEC template. Test it three times and refine based on results.

\item Pick an AI response you recently accepted without verification. Go back and verify it. What did you find?

\item Have a multi-turn conversation with AI about a real challenge you are facing. Practice the ``start broad, then narrow'' approach. Save the conversation and review what worked and what did not.

\item Ask AI to critique something you have written---a strategy document, a PRD section, an important email. Evaluate: Was the critique useful? What did it miss that a human reviewer would have caught?
\end{enumerate}
