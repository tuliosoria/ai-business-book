...
\noindent (Insert Figure: The AI Legal Landscape---Copyright, Privacy, Safety, Compliance)
...
\begin{insightbox}{Key Insight: Leverage Earned, Not Verified}
Copyrighted training data is leverage earned but not yet verified. The verification is coming in courts. You likely can't change history. But you can make honest choices going forward: use licensed data, document sources, have a legal strategy, be transparent about what you're doing.
\end{insightbox}
...
You will ship a biased model. You will make decisions that disproportionately affect some groups. The goal isn't zero bias. The ODNI AI Ethics Framework emphasizes that ethical AI requires continuous monitoring, not one-time certification [S47]. The goal is measurement (actually measure bias across demographic groups), transparency (tell users where bias might exist), intentionality (make explicit choices about trade-offs), recourse (give users a way to challenge decisions), and iteration (bias doesn't get solved once---it's an ongoing practice).

\begin{insightbox}{Key Insight: The Bias Practice}
Bias isn't a bug you fix once. It's an ongoing practice: measure across demographic groups, acknowledge limitations, make explicit trade-off choices, provide recourse, update continuously. The dangerous approach is to deploy, assume you're fair, and move on. The defensible approach is to document your testing, acknowledge limitations, and iterate.
\end{insightbox}
...
\begin{insightbox}{Key Insight: The Defensible Position}
The most defensible position is the one you can explain to a reporter, a regulator, or a victim. Not perfection---honest acknowledgment of limitations, documented testing, explicit trade-off choices, and clear recourse. Write your docs as if regulators will read them. They probably will.
\end{insightbox}
...
\noindent (Insert Table: The Honest Checklist---Questions to Answer Before Shipping AI)
...
This concludes the main content. The conclusion that follows synthesizes everything---the mindset shifts, the practical frameworks, the leadership principles---into a coherent picture of what it means to be a PM in the AI era.
