...
\begin{figure}[htbp]
\centering
\figWorkflowCompression
\caption{Workflow Compression: The traditional product cycle of Discovery → Requirements → Design → Dev (taking weeks or months) collapses into an AI-compressed workflow of Prompt → Draft → Evaluate → Ship (taking days to weeks). The bottleneck shifts from output to judgment.}
