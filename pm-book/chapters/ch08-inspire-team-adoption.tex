...
\begin{itemize}
\item Investing in tools and training
\item Changing how you measure success
\item Protecting time for learning
\item Modeling the behavior yourself
\item Being honest about what's hard
\item Celebrating small wins
\item Planning for the long term
\item Accepting that some people won't come along
\end{itemize}
