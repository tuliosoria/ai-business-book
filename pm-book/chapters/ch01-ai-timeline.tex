...
Understanding this history isn't academic indulgence. It's pattern recognition. The hype cycles, the winter periods, the moments when promise exceeded capability---these patterns still operate today. Knowing them helps you distinguish signal from noise when evaluating AI claims for your products.

\noindent (Insert Figure: AI Timeline---Major Milestones 1950-2026)
...
In 1950, Alan Turing asked a question that would haunt computer science for decades: \emph{Can machines think?} [S38] He didn't pretend to answer it philosophically. Instead, he proposed something practical: if a machine could hold a conversation indistinguishable from a human, then for practical purposes, it thinks. The Turing Test. Simple. Dangerous. Still relevant.
...
The researchers didn't give up. They kept working. But by 1974, the promises had clearly exceeded reality. The U.S. and British governments cut funding. The Lighthill Report in the UK concluded that AI had failed to achieve its ``grandiose objectives.'' The money stopped. Over 300 AI companies shut down or went bankrupt [S39].

This was the First AI Winter. It lasted six years.

\begin{insightbox}{Key Insight: The Hype-Reality Gap}
Every AI boom has followed the same pattern: early success on narrow problems creates expectations that generalize poorly. The researchers who promised human-level AI by 1970 weren't frauds---they were brilliant people who underestimated how much common sense matters. As a PM, this pattern should make you skeptical of any vendor claiming their AI ``just works'' without domain-specific validation.
\end{insightbox}
...
\begin{insightbox}{Key Insight: The Scope Problem}
Expert systems failed because they worked in small, clean domains but not in messy reality. This is still the primary failure mode for AI products today. Your model works perfectly on the training data and falls apart on edge cases. The lesson from 1987: scope your AI features narrowly, validate on real-world data, and never trust demos that only show the happy path.
\end{insightbox}
...
ChatGPT launched on November 30, 2022. It hit 100 million users in two months. Faster adoption than any application in history [S37].
...
Three things converged, and it's worth understanding each because they explain both the opportunity and the constraints you'll face building AI products.

\begin{figure}[htbp]
\centering
\figThreeConvergences
\caption{The Three Convergences: Computing power became cheap, data became abundant, and the interface became human. When all three happened simultaneously, AI went mainstream.}
...
\caption{From Months to Minutes: The AI Effect on PM Work. The traditional product cycle of Discovery → Requirements → Design → Dev → Test → Launch (taking weeks or months) collapses into an AI-compressed workflow of Prompt → Draft → Evaluate → Ship (taking minutes or hours). The bottleneck is no longer output---it's judgment.}
\label{fig:workflow-compression}
\end{figure}
...
Product managers don't need to solve that philosophical puzzle. You need to know: it works well enough for most practical tasks. It's improving. It's accessible. And it changes what's possible in your workflow.

\begin{insightbox}{Key Insight: What History Teaches PMs}
The long road from 1956 to 2023 wasn't a failure. It was prerequisite work. Each failed approach taught something. Each winter created space for new ideas. Each boom and bust clarified what actually mattered. The lesson for your career: we're not in a new age because we invented intelligence. We're in a new age because we finally made intelligence accessible. That's a different thing---and it changes everything about how you build products.
\end{insightbox}

The next chapter examines what this accessibility means for your daily work. The landscape has shifted. Understanding how is the first step to thriving in it.
