\chapter{AI as Your Daily Assistant}
...
The most immediate return on AI investment is not a moonshot project. It is replacing thirty minutes of tedious work every single day. Summarizing emails. Restructuring meeting notes. Drafting routine responses. Translating documents. The low-hanging fruit.

This chapter focuses on using AI as a daily assistant---the patterns, prompts, and habits that compound into significant productivity gains without requiring technical expertise or project approval.
...
\textbf{Examples that fit:}
\begin{itemize}
    \item Summarizing long email threads before responding
    \item Converting meeting notes into action items
    \item Drafting routine status updates
    \item Extracting key points from reports
    \item Translating customer communications
    \item Creating first drafts of standard documents
\end{itemize}

\textbf{Examples that do not fit:}
\begin{itemize}
    \item Strategic decisions requiring judgment
    \item Legal documents with compliance requirements
    \item Anything containing confidential data (more on this in Section~\ref{sec:boundaries})
    \item Novel problems with no clear pattern
\end{itemize}
...
\textbf{Common habit opportunities:}
\begin{itemize}
    \item Creating first drafts of recurring documents
    \item Preparing for specific types of meetings
    \item Reviewing and summarizing reports
    \item Drafting routine communications
    \item Extracting data from unstructured text
    \item Researching topics before decisions
\end{itemize}
